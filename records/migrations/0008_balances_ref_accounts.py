...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Balance.ref_transaction'
        db.add_column('records_balance', 'ref_transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['records.Transaction'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Balance.ref_transaction'
        db.delete_column('records_balance', 'ref_transaction_id')
    ...
    models = {
        ...
        'records.balance': {
            ...
            'ref_transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['records.Transaction']", 'null': 'True', 'blank': 'True'}),
